...
for i = 1:folds
    ...
    accHmm = accHmm + results(i).accHmm.*(test_size(i));
...
acc_tbl = table(test_size_2,train_size,acc_RF_vector,acc_Hmm_vector,'RowNames',row_folds,'VariableNames',{'Test_Size','Train_Size','RF_Acc','Hmm_Acc'});
fprintf('\n')
disp(acc_tbl)
