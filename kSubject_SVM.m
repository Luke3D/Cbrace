...
user_sigma = input('Optimized RBF sigma value for these subjects: ');
...
for k = 1:folds
    ...
    warning off;
    [trainresult,testresult] = multisvmE(features(TrainingSet,:),codesTrue(TrainingSet)',features(testSet,:),'rbf',user_sigma);
    warning on;
