...
for k = 1:folds
    ...
    fprintf('\n')
    disp(['RF Train - Subject '  num2str(user_subjects(k)) '  #Samples Train = ' num2str(N_session - (ind_change(k+1)-ind_change(k))) '  #Samples Test = ' num2str((ind_change(k+1)-ind_change(k)))]);
    ...
    if strcmp(OOBVarImp,'on')
        figure('name',['k-Subject ' num2str(user_subjects(k))])
...
fprintf('\n')
disp(['Unweighted Mean (k-Subject) accRF = ' num2str(accRF_uw)]);
disp(['Unweighted Mean (k-Subject) accRF = ' num2str(accHmm_uw)]);
disp(['Weighted Mean (k-Subject) accRF = ' num2str(accRF)]);
disp(['Weighted Mean (k-Subject) accHmm = ' num2str(accHmm)]);
